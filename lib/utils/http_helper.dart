...
class HttpHelper {
  ...
  static doGet(url, bool needToken, {Map<String, dynamic> queryParam}) async {
    return await _doRequest(url, null, new Options(method: _GET), needToken, queryParam: queryParam);
  }
  ...
  static doPut(url, params, bool needToken,
    ...
    return await _doRequest(url, params, new Options(method: _PUT), needToken, queryParam: queryParam);
  }
